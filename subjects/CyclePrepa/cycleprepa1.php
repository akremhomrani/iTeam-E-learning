...
// Check if the user's group is "Cycle Préparatoire" and year is 1
if ($group_name == 'Cycle Préparatoire' && $year == 1) {
    // Fetch modules for the group "Cycle Préparatoire" and year 1
    $sql_modules = "SELECT * FROM module 
                    ...
                    WHERE `group`.formation = 'Cycle Préparatoire' AND `group`.year = '1'";
...
<link rel="shortcut icon" type="png" href="../../images/icon/logo.PNG">
    <title>Cycle Préparatoire</title>
...
<!-- Courses Available -->
<div class="inbt">
    Courses Cycle Préparatoire 1st
</div>
        ...
        <div class="ccaardbox" id="module-list">
            <?php if ($has_modules): ?>
                <?php while ($module = mysqli_fetch_assoc($result_modules)): ?>
                    <div class="dcard">
                        <div class="fpart"></div>
                        <a href="../../profile/addcours.php?module_id=<?php echo $module['idmod']; ?>">
                            <div class="spart"><?php echo $module['title']; ?>
