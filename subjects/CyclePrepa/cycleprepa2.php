...
// Check if the user's group is "Cycle Préparatoire" and year is 2
if ($group_name == 'Cycle Préparatoire' && $year == 2) {
    // Fetch modules for the group "Cycle Préparatoire" and year 2
    $sql_modules = "SELECT * FROM module 
                    ...
                    WHERE `group`.formation = 'Cycle Préparatoire' AND `group`.year = '2'";
...
<!-- Courses Available -->
<div class="inbt">
    Courses Cycle Préparatoire 2nd
</div>
