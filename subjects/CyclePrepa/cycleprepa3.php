...
// Check if the user's group is "Cycle Préparatoire" and year is 3
if ($group_name == 'Cycle Préparatoire' && $year == 3) {
    // Fetch modules for the group "Cycle Préparatoire" and year 3
    $sql_modules = "SELECT * FROM module 
                    ...
                    WHERE `group`.formation = 'Cycle Préparatoire' AND `group`.year = '3'";
...
<!-- Courses Available -->
<div class="inbt">
    Courses Cycle Préparatoire 3nd
</div>
