...
// Check if the user's group is "Cycle ingénieur" and year is 2
if ($group_name == 'Cycle ingénieur' && $year == 2) {
    // Fetch modules for the group "Cycle ingénieur" and year 
    $sql_modules = "SELECT * FROM module 
                    ...
                    WHERE `group`.formation = 'Cycle ingénieur' AND `group`.year = '2'";
