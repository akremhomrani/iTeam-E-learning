...
// Check if the user's group is "Cycle ingénieur" and year is 3
if ($group_name == 'Cycle ingénieur' && $year == 3) {
    ...
    $sql_modules = "SELECT * FROM module 
                    ...
                    WHERE `group`.formation = 'Cycle ingénieur' AND `group`.year = '3'";
