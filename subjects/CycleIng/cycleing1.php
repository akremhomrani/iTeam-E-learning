...
// Check if the user's group is "Cycle ingénieur" and year is 1
if ($group_name == 'Cycle ingénieur' && $year == 1) {
    // Fetch modules for the group "Cycle ingénieur" and year 1
    $sql_modules = "SELECT * FROM module 
                    ...
                    WHERE `group`.formation = 'Cycle ingénieur' AND `group`.year = '1'";
