...
// Check if the user's group is "Licences" and year is 3
if ($group_name == 'Licences' && $year == 3) {
    // Fetch modules for the group "Licences" and year 3
    $sql_modules = "SELECT * FROM module 
                    ...
                    WHERE `group`.formation = 'Licences' AND `group`.year = '3'";
