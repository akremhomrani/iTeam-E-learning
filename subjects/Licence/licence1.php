...
// Check if the user's group is "Licences" and year is 1
if ($group_name == 'Licences' && $year == 1) {
    // Fetch modules for the group "Licences" and year 1
    $sql_modules = "SELECT * FROM module 
                    ...
                    WHERE `group`.formation = 'Licences' AND `group`.year = '1'";
