...
// Check if the user's group is "Licences" and year is 2
if ($group_name == 'Licences' && $year == 2) {
    // Fetch modules for the group "Licences" and year 2
    $sql_modules = "SELECT * FROM module 
                    ...
                    WHERE `group`.formation = 'Licences' AND `group`.year = '2'";
