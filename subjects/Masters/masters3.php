...
// Check if the user's group is "Masters" and year is 3
if ($group_name == 'Masters' && $year == 3) {
    // Fetch modules for the group "Masters" and year 3
    $sql_modules = "SELECT * FROM module 
                    ...
                    WHERE `group`.formation = 'Masters' AND `group`.year = '3'";
