...
// Check if the user's group is "Masters" and year is 1
if ($group_name == 'Masters' && $year == 1) {
    // Fetch modules for the group "Masters" and year 1
    $sql_modules = "SELECT * FROM module 
                    ...
                    WHERE `group`.formation = 'Masters' AND `group`.year = '1'";
